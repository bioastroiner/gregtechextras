...
//		}
		...
		CR.shaped(new ItemStack(modularBasicHelmet, 1, 32767), bits, new Object[]{"AAA", "B B", 'A', new ItemStack(Items.leather, 1, 32767), 'B', "ringAnyMetal"});
		CR.shaped(new ItemStack(modularBasicChestplate, 1, 32767), bits, new Object[]{"A A", "BAB", "AAA", 'A', new ItemStack(Items.leather, 1, 32767), 'B', "ringAnyMetal"});
		CR.shaped(new ItemStack(modularBasicLeggings, 1, 32767), bits, new Object[]{"BAB", "A A", "A A", 'A', new ItemStack(Items.leather, 1, 32767), 'B', "ringAnyMetal"});
		CR.shaped(new ItemStack(modularBasicBoots, 1, 32767), bits, new Object[]{"A A", "B B", "A A", 'A', new ItemStack(Items.leather, 1, 32767), 'B', "ringAnyMetal"});
		CR.shaped(new ItemStack(modularElectric1Helmet, 1, 32767), bits, new Object[]{"ACA", "B B", 'A', "stickAluminium", 'B', "plateSteel", 'C', "batteryAdvanced"});
		CR.shaped(new ItemStack(modularElectric1Chestplate, 1, 32767), bits, new Object[]{"A A", "BCB", "AAA", 'A', "stickAluminium", 'B', "plateSteel", 'C', "batteryAdvanced"});
		CR.shaped(new ItemStack(modularElectric1Leggings, 1, 32767), bits, new Object[]{"BCB", "A A", "A A", 'A', "stickAluminium", 'B', "plateSteel", 'C', "batteryAdvanced"});
		CR.shaped(new ItemStack(modularElectric1Boots, 1, 32767), bits, new Object[]{"A A", "BCB", "A A", 'A', "stickAluminium", 'B', "plateSteel", 'C', "batteryAdvanced"});
		CR.shaped(new ItemStack(modularElectric2Helmet, 1, 32767), bits, new Object[]{"ACA", "B B", 'A', "stickTungstensteel", 'B', "plateAlloyCarbon", 'C', "batteryMaster"});
		CR.shaped(new ItemStack(modularElectric2Chestplate, 1, 32767), bits, new Object[]{"A A", "BCB", "AAA", 'A', "stickTungstensteel", 'B', "plateAlloyCarbon", 'C', "batteryMaster"});
		CR.shaped(new ItemStack(modularElectric2Leggings, 1, 32767), bits, new Object[]{"BCB", "A A", "A A", 'A', "stickTungstensteel", 'B', "plateAlloyCarbon", 'C', "batteryMaster"});
		CR.shaped(new ItemStack(modularElectric2Boots, 1, 32767), bits, new Object[]{"A A", "BCB", "A A", 'A', "stickTungstensteel", 'B', "plateAlloyCarbon", 'C', "batteryMaster"});


		CR.remout(ST.make(MD.IC2, "itemArmorNanoHelmet", 1, 0));
		MultiTileEntityBlock tMachineNonFull = MultiTileEntityBlock.getOrCreate(GTExtras.MODID, "machine", MaterialMachines.instance, Block.soundTypeMetal, "wrench", 0, 0, 15, false, false);
