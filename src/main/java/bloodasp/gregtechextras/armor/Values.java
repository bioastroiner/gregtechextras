...
public class Values {
	...
	public Values() {
		...
		MATERIAL_MAP.put(MT.C, new Values(MT.C, 60, 0.06f, 0.23f, 0.05f, 0.05f, 0.06f));
		...
		MATERIAL_MAP.put(MT.Cr, new Values(MT.Cr, 200, 0.12f, 0.12f, 0.21f, 0.21f, 0.12f));
		...
		//MATERIAL_MAP.put(MT.Infused, new Values(MT.InfusedGold, 300, 0.15f, 0.15f, 0.05f, 0.05f, 0.15f));
		...
		MATERIAL_MAP.put(MT.U_238, new Values(MT.U_238, 290, 0.27f, 0.23f, 0.20f, 0.15f, 0.21f));
		MATERIAL_MAP.put(MT.DuraniumAlloy, new Values(MT.DuraniumAlloy, 140, 0.24f, 0.24f, 0.24f, 0.24f, 0.24f));
		...
		MATERIAL_MAP.put(MT.TritaniumAlloy, new Values(MT.TritaniumAlloy, 140, 0.26f, 0.26f, 0.26f, 0.26f, 0.26f));
		...
		MATERIAL_MAP.put(MT.Trinaquadalloy, new Values(MT.Trinaquadalloy, 300, 0.33f, 0.33f, 0.33f, 0.33f, 0.33f));
