...
public class Materials {
	...
	public static final OreDictMaterial TungstenCarbide = registerNewMaterial(OreDictMaterial.createMaterial(20000, "tungstencarbide", "Tungstencarbide")).setRGBa(80, 80, 120, 255).setQuality(14.0F, 1280, 4).setMcfg(0, C, 1 * U, W, 1 * U).addEnchantmentForTools(Enchantment.sharpness, 5),
										VanadiumSteel = registerNewMaterial(OreDictMaterial.createMaterial(20001, "vanadiumsteel", "Vanadium Steel")).setRGBa(80, 80, 120, 255).setQuality(3.0F, 1920, 3).setMcfg(0, V, 1 * U, Cr, 1 * U, Steel, 7*U),
										HSSG = registerNewMaterial(OreDictMaterial.createMaterial(20002, "hssg", "HSS-G")).setRGBa(80, 80, 120, 255).setQuality(10.0F, 4000, 3).setMcfg(0, TungstenSteel, 5 * U, Cr, 1 * U, Molybdenum, 2 * U, V, 1 * U),
										HSSE = registerNewMaterial(OreDictMaterial.createMaterial(20003, "hsse", "HSS-E")).setRGBa(80, 80, 120, 255).setQuality(10.0F, 5120, 4).setMcfg(0, HSSG, 6 * U, Cobalt, 1 * U, Manganese, 1 * U, Si, 1 * U),
